...
We recommend creating one directory for each project. All your data and files for your project will live in this one directory. You'll also often want to create an RStudio project for your project. 

Ideally, you'll organize your files in this directory in a principled way. We've created a project template with our suggested folder organization. You can quickly create a project that uses this template with the dcl package. 

If you haven't already, install the dcl package:
...
`dcl::create_data_project(path = "MY/PROJECT/PATH")`
...
* Name your token something like _RStudio_ or _R_. The name doesn't really matter--it's just a way to keep track of your different tokens. Under _Scopes_, select _repo_ (you'll only need the repo scope for this chpater, but you can select other scopes if you anticipate using the GitHub API in more scenarios.)
