...
Name each script the same name as the raw data source. For example, the script __collisions.R__ reads in __collisions.csv__, cleans the data, then writes _collisions.rds_ to __data__ using `readr::write_rds()`. 
