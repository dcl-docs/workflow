...
You can run R script code with the same keyboard shortcuts you use to run code in chunks ( _Cmd_ + _Enter_ to run one pipe; _Cmd_ + _Shift_ + _Enter_ to run all code; highlight and _Cmd_ + _Enter_ to just run highlighted code). You can also run the whole script by clicking _Source_ in the upper-right corner. 
