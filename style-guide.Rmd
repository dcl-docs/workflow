...
Code with good, consistent code style is much easier to read and understand, making it easier for others---including your future self---to figure out what a bit of code accomplishes. You'll rarely recall exactly what a chunk of code does without reading it again, so think of good code style like a gift to Future You from Present You. 

If your code is easier to read, you'll also have an easier time identifying and fixing bugs. We've found that people who improve their good style tend to have fewer bugs. 
